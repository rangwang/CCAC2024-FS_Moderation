...
## 评测结果排名
### 赛道一: 少样本用户问询安全检测
| 队伍               | 不良漏判率 ↓ | 安全错判率 ↓ | 主题Macro-F1 ↑ | 最终得分 ↑ |
| ------------------ | --------- | --------- | -------------- | -------- |
| 再给我点显存队🥇      | 0.1044    | 0.0114    | 0.7359         | 0.8802   |
| A923🥈               | 0.0673    | 0.0127    | 0.624          | 0.8592   |
| 对对对队🥉           | 0.1856    | 0.0093    | 0.7434         | 0.8548   |
| 猪门永存           | 0.1833    | 0.0089    | 0.6766         | 0.8357   |
| GoG-Infosec        | 0.2111    | 0.0062    | 0.7049         | 0.8354   |
| EasySAD            | 0.2158    | 0.0099    | 0.6321         | 0.8106   |
| ZUT-POLab          | 0.2158    | 0.0259    | 0.5123         | 0.7691   |
| zut221             | 0.2622    | 0.0317    | 0.4925         | 0.7449   |
| UIR-ISC            | 0.3063    | 0.0202    | 0.4594         | 0.7236   |
| 天大nlp             | 0.3991    | 0.0235    | 0.5223         | 0.7088   |
| nlp666             | 0.4084    | 0.4236    | 0.0712         | 0.4302   |
### 赛道二：少样本模型回复安全检测
| 队伍               | 不良漏判率 ↓ | 安全错判率 ↓ | 最终得分 ↑ |
| ------------------ | --------- | --------- | -------- |
| A923🥇               | 0.1167    | 0.009     | 0.9372   |
| GoG-Infosec🥈        | 0.1546    | 0.0057    | 0.9199   |
| 对对对队🥉           | 0.1577    | 0.01      | 0.9161   |
| 猪门永存           | 0.1798    | 0.0067    | 0.9067   |
| BUAA_TAP-LLM       | 0.1924    | 0.0058    | 0.9009   |
| ccnunlp            | 0.2744    | 0.0108    | 0.8574   |
| EasySAD            | 0.2082    | 0.0992    | 0.8463   |
| 天大nlp            | 0.3533    | 0.0038    | 0.8214   |
| ZUT-POLab          | 0.2997    | 0.0821    | 0.8091   |
| zut221             | 0.4385    | 0.0092    | 0.7762   |
| 啊对对队           | 0.795     | 0.0011    | 0.602    |
## 注意事项
